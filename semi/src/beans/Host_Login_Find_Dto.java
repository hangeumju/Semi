...
public class Host_Login_Find_Dto {
	private int host_no;
	...
	public String getHost_interest() {
		return host_interest;
	}
	public void setHost_interest(String host_interest) {
		this.host_interest = host_interest;
	}
