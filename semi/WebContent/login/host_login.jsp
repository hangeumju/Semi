...
<!-- ID 입력창 -->
<div class="row">
<input class="block-item input-item" name ="host_id" placeholder="아이디 입력" required></div>
<!-- PW 입력창 -->
<div class="row">
<input class="block-item input-item" name ="host_pw" placeholder="비밀번호 입력" required></div>
<!-- login 버튼-->
<div class="row-left">
