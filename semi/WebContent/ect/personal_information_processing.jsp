...
<div>
개인정보 수집 및 이용 안내
주식회사 kh당일치기(이하 “회사”)는 회원님의 개인정보를 보호하기 위해 최선을 다하고 있습니다. 이를 위해서 회사는 개인정보의 보호와 관련하여 ‘정보통신망 이용촉진 및 정보보호 등에 관한 법률’, ‘개인정보 보호법’ 등 개인정보와 관련된 법령을 준수하고 있습니다.
</div><br><br><div>
1. 수집하는 개인정보의 항목
...
- 탑승자 이름, 동반인정보(성명, 이외 서비스의 유형에 따라, 추가적인 정보가 수집될 수 있습니다.) (여행상품)
4) 모바일 사용 시
- 당일치기 앱 버전, OS버전 (IOS, 안드로이드)
- 위치정보 (별도 저장없이 앱에서 사용)
5) 기타
- 서비스 이용과정에서 자동 수집 정보 : IP Address, 쿠키, 방문 일시, 서비스 이용 기록, 불량 이용 기록, 기기정보, ADID, IDFA, 위치정보
-고객 분쟁처리 및 상담 진행 시 : 상담내역, 서비스 이용기록, 결제 및 환불 기록
6) 구독회원
- E-MAIL, 성별
</div><br><br><div>
2. 개인정보의 수집 및 이용목적
...
제공받는 자 : 호스트
제공하는 항목 : 이름, 성별, 나이, 연락처, 의류 사이즈 등 개별 프로그램별로 필요하여 회원이 입력한 정보
...
13. 시행시기
본 개인정보처리방침은 2019년 06월 12일부터 시행됩니다.
</div>
</h5>
</div>
